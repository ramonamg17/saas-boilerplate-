...
from backend.core.email import send_magic_link, send_welcome
...
async def migrate_guest(
    ...
    Product-specific migration logic should be added here.
    """
    # EDIT PER PROJECT — implement guest data migration
